...
const AppDrawerNavigator=createDrawerNavigator({Main:{screen:TabNavigator},ToDoList:{screen:ToDoScreen},Settings:{screen:SettingScreen},NotificationScreen:{screen:NotificationScreen}},{contentComponent:Drawer},{initialRouteName:'Main'})
